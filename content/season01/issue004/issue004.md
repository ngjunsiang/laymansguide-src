...
![Screenshot of a Hypothes.is profile page]({attach}/season1/issue004/issue004_01.png)
...
![Data from the Hypothes.is API, JSON]({attach}/season1/issue004/issue004_02.png)
...
![Data from the Hypothes.is API, XML]({attach}/season1/issue004/issue004_03.png)<br />
