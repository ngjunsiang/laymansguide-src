...
- [Replicate](https://replicate.com/explore) provides an even simpler interface, but for a smaller catalogue of models. Try out the models directly on the model card page, or create an account for deployment options.
...
Buttondown still does not have a very browseable archive, so I've made the newsletter content available on a static site. You can browse past seasons more easily at [https://ngjunsiang.github.io/laymansguide/categories](https://ngjunsiang.github.io/laymansguide/categories).
