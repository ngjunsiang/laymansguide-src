...
Then Quantcast got thinking: what if we could get these cookies synchronised? Better yet, what if we could get all these companies to load our tracking script on their sites ([Issue 70]({filename}/season06/issue070/issue070.md))) and thereby put _our cookie_ on their sites? We would be able to gather cross-site data and build a more complete profile of the audience!
