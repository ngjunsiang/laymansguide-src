...
In [Issue 157]({filename}/season13/issue157/issue157.md
...
Let’s think through the **distribution** of that content. Text is generally small in size and easy to pass around, even through multiple hops ([Issue 36]({filename}/season3/issue036/issue036.md

### Server load

What about the heavy stuff, like hi-res images and videos? Thousands or millions of clients all requesting the same large video file from your hosting server. That server is going to be spending many CPU cycles ([Issue 58]({filename}/season5/issue058/issue058.md

Some of that processing can be mitigated with techniques such as caching ([Issue 39]({filename}/season3/issue039/issue039.md
