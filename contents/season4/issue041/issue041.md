...
![ITA2 table]({attach}issue041_01.jpg?raw=true)<br />
...
![Morse Code table]({attach}issue041_02.png)<br />
...
![A typewriter on a table]({attach}issue041_03.jpg?raw=true)<br />
...
![ASCII code chart]({attach}issue041_04.png)<br />
...
![An HTTP request captured in Wireshark showing my developer API key]({attach}issue012_01.png)<br />
