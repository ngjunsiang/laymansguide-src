...
- XHR (XmlHTTPRequests) are requests for other resources—to verify a Captcha, get a winning ad bid ([Issue 73]({filename}/season6/issue073/issue073.md
...
CSS and images are considered important and quite harmless, and are thus allowed by default. First-party resources ([Issue 76]({filename}/season6/issue076/issue076.md
...
- Big websites often load their unchanging (static) resources, such as images, CSS files, script files, etc, from a separate domain.  
  Presumably they do this so that this other domain can be set up for caching ([Issue 39]({filename}/season3/issue039/issue039.md
