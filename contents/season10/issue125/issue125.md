...
The bulk of the story has been written in [Issue 123]({filename}/season10/issue123/issue123.md
...
Digital formats differ from analog formats, because they do not carry the raw signal for the device. Instead, they carry information about the image, encoding the image data ([Issue 43]({filename}/season4/issue043/issue043.md
...
The graphics card is in charge of converting the final rasterised signal ([Issue 122]({filename}/season10/issue122/issue122.md
