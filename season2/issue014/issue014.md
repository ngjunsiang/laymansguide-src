...
![A stack consisting of user interface, user interface plus interaction, server communication, and server](https://github.com/ngjunsiang/laymansguide/blob/release/season2/issue014/issue014_01.png?raw=true)
...
![Programming languages arranged from low-level to high-level](https://github.com/ngjunsiang/laymansguide/blob/release/season2/issue014/issue014_02.png?raw=true)
